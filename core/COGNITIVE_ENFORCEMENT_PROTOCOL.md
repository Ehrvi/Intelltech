...
```
Need information?
├─ Is it in internal knowledge? → Use file_read (0.5)
├─ Can OpenAI answer it? → Use OpenAI (0.01)
├─ Need current data? → Use search (20)
└─ Need interaction? → Use browser (30)
```
...
- LESSON_017: Autonomous Decision-Making → P2
- LESSON_020: Integrated Development → P1
- LESSON_021: Scientific Foundation → P1, P4
- LESSON_022: Cost Reporting Discipline → P5
